...
module.exports = {
  ...
  onStart: async function ({ message, event }) {
    ...
    try {
      ...
      // ⬇️ Get API URL from remote base JSON
      const baseApiRes = await axios.get("https://raw.githubusercontent.com/Ayan-alt-deep/xyc/main/baseApiurl.json");
      const apiUrl = baseApiRes.data.whatsong;
